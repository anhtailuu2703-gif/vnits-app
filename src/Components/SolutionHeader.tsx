        ...
        >
            ...
            <div className="solution-header-container">
                <div className="solution-header-content">
                    ...
                    <Link className="inline-flex items-center gap-2 text-white/50 hover:text-white transition-colors text-sm font-medium mb-8" to="/vnits" data-discover="true" style={{ textDecoration: "none", paddingBottom: "30px" }}>
